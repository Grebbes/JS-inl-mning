...
const locations = [
  {name: "Town Square",
   "button text": ["Enter the armory", "Enter the potion shop", "Hunt for orcs", "Raid the orc encampment"],
  ...
  {
    name: "Armory",
    "button text": ["Buy weapon(30gold)", "Buy armour(10gold)", "Go back to town square"],
  ...
  {
    name: "Hunting",
    "button text": ["Fight rabid beast", "Fight Orc raider", "Fight Orc shaman", "Go back to town"],
